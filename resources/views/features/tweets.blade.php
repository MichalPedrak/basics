                                ...
                                <div class="d-flex">
                                    <div class="media mt-0">
                                        ...
                                        <div class="media-user me-2">
                                            <div class=""><a href="/users/{{ $tweet->user->id }}"><img alt="" class="rounded-circle avatar avatar-md" src="https://i.pravatar.cc/80/{{ $tweet->user->id }}"></a></div>
                                        </div>
                                        <div class="media-body">
                                            <h6 class="mb-0 mt-1"><a href="/users/{{ $tweet->user->id }}">{{ $tweet->user->name }}</a></h6>
